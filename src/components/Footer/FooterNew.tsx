...
const FooterNew = () => {
  return (
    <>
      <footer className="bg-[#0a0f2d] text-white">
        <div className="mx-auto w-full max-w-8xl p-4 pl-30 pr-30 py-6 lg:py-8">
          <div className="md:flex md:justify-between items-center">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul className="text-body font-medium">
                  <li className="mb-4 text-sm font-light flex items-center">
                    <BsTelephone className="mr-3 text-md font-light" />
                    +94 XXXXXXXX
                  </li>
                  <li className="mb-4 text-sm font-light flex">
                    <AiOutlineMail className="mr-3 text-md md:text-xl" />
